...
public class Card  extends ImageView {
    ...
    private final ArrayList<Integer> found_cards;
    
    public Card(int number) {
        
        circles     =  new ArrayList<>();
        found_cards = new ArrayList<>();
            ...
            case PRIMARY -> {
                ...
                for(var cercle : circles) {
                    if(cercle.isInside(x, y)) {
                        if(! found_cards.contains(cercle.getNumero())) {
                            found_cards.add(cercle.getNumero());
                        }
                    }
                }
            }
    ...
    public ArrayList<Integer> getCartesTrouvees() {
        return found_cards;
    }
